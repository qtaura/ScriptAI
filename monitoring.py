...
class MonitoringManager:
    ...
    def log_request(self, model: str, prompt_length: int, response_time: float, 
        ...
        self.logger.log(log_level, f"Request: model={model}, time={response_time:.2f}s, success={success}")
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': round(
                sum(1 for m in self.performance_metrics if m['success']) / len(self.performance_metrics) * 100, 2
            )
        }
